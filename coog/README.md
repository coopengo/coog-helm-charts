...
![Version: 2.10.2241-3](https://img.shields.io/badge/Version-2.10.2241--3-informational?style=flat-square) ![AppVersion: coog-2.10](https://img.shields.io/badge/AppVersion-coog--2.10-informational?style=flat-square)
...
| celery.cron.resources | object | `{"limits":{"cpu":"200m","memory":"300Mi"},"requests":{"cpu":"160m","memory":"240Mi"}}` | celery cron job containers' resource requests and limits |
